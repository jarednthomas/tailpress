...
# Pulling from origin upstream/master (example origin upstream/master: jeffreyvr/tailpress)
git remote add upstream https://github.com/jeffreyvr/tailpress.git
git fetch upstream
